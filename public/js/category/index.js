...
/*!********************************************************!*\
  !*** ./resources/js/project_scripts/category/index.js ***!
  \********************************************************/
var vue = new Vue({
  el: '#index',
  components: {},
  ...
  methods: {
    ...
    initList: function initList() {
      ...
      loading(true);
      var url = this.url + "/jsonIndex/" + this.discriminator + (this.filterText === '' ? '' : '/') + this.filterText + '?page=' + page;
    ...
    initFormCreate: function initFormCreate() {
      ...
      loading(true);
      var url = this.url + "/jsonCreate/" + this.discriminator;
      window.axios.get(url).then(function (response) {
    ...
    initFormDetail: function initFormDetail(idCategory, callback) {
      var _this3 = this;

      loading(true);
      var url = this.url + "/jsonDetail/" + idCategory;
      window.axios.get(url).then(function (response) {
    ...
    softDelete: function softDelete(idCategory) {
      var _this5 = this;
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          _this5.initFormDetail(idCategory, function () {
